...
export const SplitScreenLogin: React.FC<SplitScreenLoginProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err?.message || 'Invalid credentials. Please verify or register a new account.');
    } finally {
    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-slate-900 text-slate-100 overflow-x-hidden selection:bg-teal-500 selection:text-white">
      ...
      <div className="lg:w-1/2 p-6 sm:p-12 lg:p-16 flex flex-col justify-center items-center relative bg-slate-950">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          {/* Error notification */}
          {error && (
            <div className="p-3 rounded-xl bg-rose-500/10 border border-rose-500/40 text-rose-300 text-xs flex items-center gap-2.5 animate-in fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="e.g. contact@yourfirm.com or username"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-2.5 rounded-xl bg-navy-900/80 border border-slate-700/80 text-white placeholder-slate-500 text-xs sm:text-sm focus:outline-none focus:border-teal-400 focus:ring-1 focus:ring-teal-400 transition-colors"
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="w-full mt-2 py-3 px-4 rounded-xl font-bold text-sm text-white bg-gradient-to-r from-teal-500 via-teal-600 to-sky-600 hover:from-teal-400 hover:to-sky-500 shadow-glow-teal flex items-center justify-center gap-2 transition-all transform active:scale-[0.99] cursor-pointer disabled:opacity-50"
            >
              <span>{isSubmitting ? 'Signing in...' : `${t('login')} as ${selectedRole === 'sender' ? 'Sender (Exporter)' : 'Receiver (Buyer)'}`}</span>
